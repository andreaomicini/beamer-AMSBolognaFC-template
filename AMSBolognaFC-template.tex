...
\begin{itemize}
	...
	\item since style 1.7.5 no character in the address needs escaping, in these commands as in \texttt{\textbackslash{}ddoi} and \texttt{\textbackslash{}dddoi}
\end{itemize}
\end{block}
%
