...
Every \href{https://github.com/andreaomicini/beamer-AMSBolognaFC/releases}{release} of the style attaches a \texttt{style.zip} holding everything needed
\begin{itemize}
	\item \texttt{beamerthemeAMSBolognaFC.sty}, \texttt{beamercolorthemebolognafc.sty}
...
\end{block}
%
\begin{block}{\texttt{\textbackslash{}dddoi} command---e.g., \dddoi{10.1007/978-3-032-22940-3}} % chktex 8
\begin{itemize}
	\item to be used for the styled DOI URLs over dark backgrounds
	\item[e.g.] see \verb|\dddoi{10.1007/978-3-032-22940-3}| above in this \texttt{block} header % chktex 8
\end{itemize}
\end{block}
%
\end{frame}
